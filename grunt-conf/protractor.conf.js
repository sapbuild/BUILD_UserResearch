...
'use strict';
var port = require('../sample/server/config.json').http.port;
...
exports.config = {
    ...
    cucumberOpts: {
        require: ['./protractor_logger.js','../node_modules/norman-*-e2e/e2e/testcases/steps/*.steps.js',
            '../test/e2e/testcases/steps/*.steps.js'],
        format: 'json'
    }
};
