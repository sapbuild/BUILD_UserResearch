...
angular.module('UserResearch')
    .config(function ($stateProvider) {
        $stateProvider
            ...
            .state('shell.project.UserResearch.review.questions.detail', {
                url: '/:questionId/details',
                onEnter: function ($stateParams, $state, $rootScope, $timeout) {
                    $timeout(function () {
                        if (!$stateParams.action) {
                            $rootScope.$broadcast('dialog-open', 'review-detail-modal');
                        }
                        $rootScope.$broadcast('init-review-details', {
