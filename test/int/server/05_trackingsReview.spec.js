...
describe('Trackings & Review Service REST API Test', function () {
    ...
    before('Initialize API', function (done) {
        mainTestUser.initialize(mainTestUserNameEmail, 'Minisap!1').then(function () {
    ...
    it('Get Review Stats for a study that doesnt exist', function (done) {
        ReviewApi.getStudyStats(mainTestUser, projectId, '3cca4ada7bf21fd10a94adbc', 404)
            .then(function (res) {
    ...
    it('Get Question Stats for non-existent study', function (done) {
        ReviewApi.getQuestionStats(mainTestUser, projectId, '3cca4ada7bf21fd10a94adbc', questionId3, 404)
            .then(function (res) {
                expect(res.body).to.not.eq(undefined);
                done();
            }).catch(function (err) {
