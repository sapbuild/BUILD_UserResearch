...
var salesItemPageUrl = '/deploy/public/667d29b3a2c455a20a326682/5/index.html#/SalesOrder/SalesOrderItem(\'1234\')/SalesOrderItem(\'2345\')'
...
describe('ParticipantService SmartTemplate REST API Test', function () {
    ...
    before('Initialize API users and set up test data', function (done) {
        ...
        mainTestUser.initialize(mainTestUserNameEmail, 'Minisap!1')
            .then(function () {
                // set up user2
                return user2.initialize(userTwoNameEmail, 'Minisap!1');
            })
            .then(function () {
            ...
            .then(function (res) {
                ...
                var testDeepLinks = {
                    ...
                    {
                        pageUrl: salesItemPageUrl,
                        thumbnail: '/deploy/public/667d29b3a2c455a20a326682/5/resources/thumbnail/SalesOrder/SalesOrderItem(\'1234\').png'
                    }]
                };
                var mockedService = {
    ...
    it('[11] User One (Review) - Should see breakdown for User One and  overview details in the review Stats ', function (done) {
        ReviewApi.getStudyStats(mainTestUser, projectId, studyId, 200)
            .then(function (res) {
                ...
                expect(taskDetails.links.length).to.equal(3);
