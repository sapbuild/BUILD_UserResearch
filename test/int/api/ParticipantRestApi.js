 ...
 * @returns Promise - response
 */
ParticipantRestApi.prototype.getAnswer = function (userContext, studyId, answerId, httpCodeExpected) {
    var deferred = Promise.defer();
    userContext.normanTestRequester.reqGet('/api/participant/studies/' + studyId + '/answers/' + answerId, httpCodeExpected, resolver(deferred));
    return deferred.promise;
};
