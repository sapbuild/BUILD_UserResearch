...
UserRe.prototype = Object.create({}, {
    ...
    singleImgThumb:                { get: function ()                 { return element(by.css('.complete-tick')); }},
    ...
    browseBtn:               { get:   function ()            { return element(by.css('.ur-action-icon.icon-annotation-blue')); }},
    ...
    prototypePageName: {    get:  function ()   { return element.all(by.css('.edit-task-thumbnail-name')); }},
    pageFlowTileName: {    get:  function ()   { return element.all(by.binding('page.fullName')); }},

    studyTile:            { get:   function ()            { return element.all(by.css( '.ui-study-tile' )); }},
    ...
    ansFreeTxt2:{get:   function ()             {   return element(by.css('label[for="questionType2-1"]')); }},
    ...
    sendInviteBtn:          {    get: function ()       {       return element(by.css('.btn-invite')); }},
    clickSendInviteBtn:     {    value: function()      {       this.sendInviteBtn.click()}},

    pendingSendInviteList:   {   get: function ()        {       return element(by.css('.invite-send-label'))}},
    ...
    freeText2: {   value: function () {
        this.ansFreeTxt2.click();
    }},
    ...
    clickTile:  { value: function(num)  {   return this.imgScreens.get(num).click()}},
    ...
    enterQuestion2:{ value: function(keys)  {return this.screen_txtQuestions.get(1).sendKeys(keys)}},
    ...
    EnterQuestionFreeTextOnly2:              { value: function (question) {
        this.enterQuestion2(question);
    }},
    ...
    clickSingleImgThumbs: { value: function()       {
        this.singleImgThumb.click();
        browser.waitForAngular();
    }},
    ...
    clickTextBox:               { get: function ()      {       return element(by.css('Please provide any feedback you may have.')); }},
    clickClickTextBox:          { value: function ()    {       this.clickTextBox.click(); }},

    changeCss: {
        value: function () {
            var control = browser.driver.findElement(by.css('.icon-plus'));
            browser.driver.executeScript("arguments[0].style.display = 'inline'; ", control).then(function () {
