...
Partic.prototype = Object.create({}, {
    ...
    btnDoneStudy:          { get:   function ()            { return element(by.css( '[ng-click="goToList()"]' )); }},
    answerPanel:          { get:   function ()            { return element(by.css( ' .question-panel' )); }},

    participantProgBar: { get:   function ()            { return element(by.css( '[ng-click="returnToStudy()"]' )); }},
    ...
    abandoned:          { get:   function ()             { return element(by.css( '.abandoned-text' )); }},
...
//    freeTextAnswer:        { get:   function ()            { return element.all(by.css('.annotation-comment'));}},
    ...
    AbandonTask:           { get:   function ()             { return element(by.css( '.abandon-task' )); }},
    confAbandon:           { get:   function ()             { return element(by.buttonText('YES, ABANDON')); }},
    ...
    clickProtoLink:{   value: function()           {
        browser.sleep(750);
        browser.driver.findElement(by.css('.sapMLnk')).click();
        browser.sleep(750);
    }},
    ...
    clickAbandonTask:{   value: function()           { this.AbandonTask.click()}},
    clickConfAbandonTask:{   value: function()           { this.confAbandon.click()}},
