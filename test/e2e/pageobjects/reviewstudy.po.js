...
StudyReview.prototype = Object.create({}, {
    ...
    reviewFilters:  {get:   function ()            { return element.all(by.css( '.filterOption' )); }},

    clickFilter:{   value: function(pos)           { this.reviewFilters.get(pos).click(); browser.waitForAngular()}},
    ...
    questionSuccessTotal: {get:    function () {       return element.all(by.id('question-successful-total' )); }},
    questionFailedTotal: {get:    function () {       return element.all(by.id('question-failed-total' )); }},
    questionAbandonedTotal: {get:    function () {       return element.all(by.id('question-abandoned-total' )); }},
