...
Feature: Review Study Tasks & Questions Detailed Statistics
    ...
    Scenario: Review Task Overview for Prototype Task 1
        ...
        Then   Stats Target Reached equals "0" with percentage "0%"
        Then   Stats Not Target Reached equals "3" with percentage "100%"
        Then   Stats Abandoned equals "0" with percentage "0%"
        ...
        Then   Proto Page "1" Task Status Count equals "0"
        ...
        Then   Proto Page "2" Task Status Count equals "3"
    ...
    Scenario: Review Page Flow for Prototype Task 1
        Given  I am in Question Review Page
        When   I click on the Page Flow Tab
        Then   I can see the Page Flow
        Then   I see "2" nodes
        And    I see Page "1" with name "index.html" exists
        And    I see Page "2" with name "page1.html" exists

    Scenario: Review Statistics for Prototype Task 1
        Given  I am in Question Review Page
        ...
        Then   I see the Task Statstics Task Target Reached equals "0" with percentage "0%"
        Then   I see the Task Statstics Task Target Not Reached equals "3" with percentage "100%"
        Then   I see the Task Statstics Task Abandoned equals "0" with percentage "0%"
    ...
    Scenario: Review Task Overview for Prototype Task 2
        Given  I am in Question Review Page
        When   I click Next
        Then   Stats Target Reached equals "2" with percentage "66.67%"
        Then   Stats Not Target Reached equals "0" with percentage "0%"
        Then   Stats Abandoned equals "1" with percentage "33.33%"
        Then   Proto Page "1" Participants Count equals "3"
        Then   Proto Page "1" Annotations Count equals "6"
        Then   Proto Page "1" Comments Count equals "6"
        ...
        Then   Proto Page "2" Annotations Count equals "3"
        Then   Proto Page "2" Comments Count equals "3"
        Then   Proto Page "2" Task Status Count equals "0"
        Then   Proto Page "2" Task "Positive" Sentiment "1" with percentage "33%"
        Then   Proto Page "2" Task "Nuetral" Sentiment "1" with percentage "33%"
        Then   Proto Page "2" Task "Negative" Sentiment "1" with percentage "33%"
    ...
    Scenario: Review Statistics for Prototype Task
        ...
        Then   I see the Task Statstics Task Target Not Reached equals "0" with percentage "0%"
        Then   I see the "Task" Statstics Task Annotation "Positive" Sentiment "3" with percentage "33.33%"
        Then   I see the "Task" Statstics Task Annotation "Nuetral" Sentiment "3" with percentage "33.33%"
        Then   I see the "Task" Statstics Task Annotation "Negative" Sentiment "3" with percentage "33.33%"
